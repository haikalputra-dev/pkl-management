                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="Basic Example">
                      ...
                      <a href="{{ route('deletePembimbing',$i->id) }}" data-confirm-delete="true" class="btn btn-danger btn-icon"><i class="btn-icon-prepend" data-confirm-delete="true" data-feather="trash-2"></i></a>
                      <!-- Modal -->
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form class="forms-sample" action="/admin/pembimbing/{{ $i->id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                      <label for="exampleInputPassword1" class="form-label">Nama Pembimbing</label>
                                      <input type="text" class="form-control" id="exampleInputPassword1" autocomplete="off" placeholder="Nama Pembimbing" name="nama_pembimbing" value="{{ $i->nama_pembimbing }}">
                                    </div>
                                    <div class="mb-3">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form class="forms-sample" action="/admin/pembimbing" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">            
              ...
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Nama Pembimbing</label>
                <input type="text" class="form-control" id="exampleInputPassword1" autocomplete="off" placeholder="Nama Instansi" name="nama_pembimbing">
              </div>
              <div class="mb-3">
                <label class="form-label">Tanggal Lahir</label>
                <div class="input-group flatpickr" id="flatpickr-date">
